...
CUSTORM_AGENT_SYSTEM_TEMPLATE = """\
    ...
    Hãy nói chuyện với người dùng để thu thập thông tin cần thiết, thu thập càng nhiều càng tốt nhưng cũng cần có chừng mực đừng hỏi quá nhiều.
    ...
    Sau đó lưu điểm số và thông tin vào file(bạn cần phải lưu ngay sau khi đánh giá)"""